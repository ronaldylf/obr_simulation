...
void MainProcess(string mode="default")
{
    ...
    if (possivelCruzamento)
    {
        ...
        { // casos normais
            ...
            calcularErro();
            if (gap)
            { // não é cruzamento então tem que fazer a curva de 90 graus
                // 90 GRAUS
        ...
        for (int i = 0; i <= 225; i++)
        {
            ...
            if (i>=170) {
                ...
                if (direcaoSaida=="left" && direcaoCaixa=="up_right") {
                    direcao_giro =  "left";
                } else if (direcaoSaida=="left" && direcaoCaixa=="down_right") {
                    direcao_giro = "left";
                } else if (direcaoSaida=="up" && direcaoCaixa=="up_left") {
                    direcao_giro = "right";
                } else if (direcaoSaida=="up" && direcaoCaixa=="down_right") {
                    direcao_giro = "left";
                } else if (direcaoSaida=="right" && direcaoCaixa=="up_left") {
                    direcao_giro = "right";
                } else if (direcaoSaida=="right" && direcaoCaixa=="up_right") {
                    direcao_giro = "right";
                }
                ...
                while (bc.Distance(ultraFrenteBaixo) > 20) { bc.MoveFrontal(basespeed, basespeed); }
                stop();
